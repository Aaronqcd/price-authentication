...
public class JXLMaker {
  ...
  public String getCellType(String strTmpCell) {
		...
		if (strTmpCell.indexOf(".") > -1) {
			...
			if(DateUtil.checkDateValidity(strTmpCell)){
...
//			}
	...
	public void addDateCell(String dbData, int row, int column)
		...
		DateTime dt = new DateTime(column, row, DateUtil.stringToTime(dbData),
				cf1);
		_sheet.addCell(dt);
	}
	...
	public void addDateTimeCell(String dbData, int row, int column)
		...
		DateTime dt = new DateTime(column, row, DateUtil.stringToTime(dbData), cf1);
		_sheet.addCell(dt);
	}
	...
	public static void main(String[] arg) throws Exception {
		...
		String[] type = new String[] { "Double", "Double_3_Scale",
				"Double_5_Scale_KC", "String", "Double"};//, "Date", "Time" };
		...
		String[] v = new String[] { "124.556", "2354645745.3", "2333.5e-5",
				"adgf", "2.44545", "2004-3-1", "12:3:1" };
		//data.addRow(v);

		v = new String[] { "2.7194", "2.0307", "2333e5", "dfhh",
				"-2.44545", "2001-2-1", "14:23:1" };
		//data.addRow(v);
