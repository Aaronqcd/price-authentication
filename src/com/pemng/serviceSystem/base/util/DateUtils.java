/**    
 * description: 
 * Create on Sep 25, 2008 4:20:35 PM    
 *      
 */    
...
public class DateUtils {
	...
	public static final SimpleDateFormat YYYYMMDD_NO_FORMAT = new SimpleDateFormat("yyyyMMdd");
	
	public static final SimpleDateFormat YYYYMM_FORMAT = new SimpleDateFormat("yyyy-MM");

	public static final SimpleDateFormat YYYYMM_NO_FORMAT = new SimpleDateFormat("yyyyMM");
	
	public static final SimpleDateFormat MMDD_FORMAT = new SimpleDateFormat("MM-dd");
	
	public static final SimpleDateFormat HHMM_FORMAT = new SimpleDateFormat("HH:mm");
	...
	/**
	 * 取得当天的最大时间，如2011-11-12 23:59:59
	 * @param args
	 */
	...
	/**
	 * 取得明天的最小时间，如2011-11-12 00:00:00
	 * @param args
	 */
	...
	public static java.sql.Date utilDate2SqlDate(Date date) {
		...
		java.sql.Date sqlDate = java.sql.Date.valueOf(sdf.format(date));
		return sqlDate;
	}
