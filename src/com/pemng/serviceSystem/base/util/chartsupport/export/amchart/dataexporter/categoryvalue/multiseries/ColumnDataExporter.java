...
import com.pemng.serviceSystem.base.util.chartsupport.export.amchart.ColumnXmlDataAmchartsExporter;

public class ColumnDataExporter implements MultiSeriesDataExporter {
	
	private ColumnXmlDataAmchartsExporter innerExporter;
	private AmchartsMultiSeriesCategoryValueChart chart;
	
	public ColumnDataExporter() {
		innerExporter = new ColumnXmlDataAmchartsExporter();
	}
