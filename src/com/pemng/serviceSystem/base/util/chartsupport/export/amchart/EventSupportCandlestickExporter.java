 ...
 * 
 */
public class EventSupportCandlestickExporter extends DefaultCandlestickExporter
		implements CandlestickExporter, EventSupportExporter {
	...
	private String getEventXmlData(List<Event> events, String datePattern) {
		...
		for (Event event : events) {
			...
			sb.append("</letter>");
			// update 2012-06-12 liaojianxiong  add
			sb.append("<bullet>pin</bullet>");
			sb.append("<color>#999999</color>");
			sb.append("<size>16</size>");
			sb.append("<border_width>1</border_width>");
			sb.append("<border_alpha>0</border_alpha>");
			sb.append("<border_color>#CCCCCC</border_color>");
			sb.append(" <text_color>#ffffff</text_color>");
			sb.append("</event>");
		}
