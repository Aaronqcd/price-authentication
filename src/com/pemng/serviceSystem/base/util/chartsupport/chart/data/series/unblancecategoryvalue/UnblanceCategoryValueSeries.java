 ...
 * 
 */
public interface UnblanceCategoryValueSeries extends Series {
	 ...
	 */
	void addCategoryValuePoint(UnblanceCategoryValuePoint point)
	 ...
	 */
	boolean removeCategoryValuePoint(UnblanceCategoryValuePoint point);
	 ...
	 * @return 所有的数据节点
	 */
	List<UnblanceCategoryValuePoint> categoryValuePoints();
}
