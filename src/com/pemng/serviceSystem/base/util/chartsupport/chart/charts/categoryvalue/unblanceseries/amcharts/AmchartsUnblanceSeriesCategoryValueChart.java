...
import com.pemng.serviceSystem.base.util.chartsupport.chart.charts.categoryvalue.unblanceseries.UnblanceSeriesCategoryValueChart;
 ...
 * 
 */
public interface AmchartsUnblanceSeriesCategoryValueChart extends UnblanceSeriesCategoryValueChart {
	/**
	 * 设置一个刻度坐标轴
	 * 
	 * @param categoryAxis
	 ...
	 */
	void addCategoryValueSeries(UnblanceCategoryValueSeries categoryValueSeries,boolean iniCategoryAxis);
}
