 ...
 * 
 */
public interface MultiSeriesCategoryValueChartFileBuilder extends
		ChartFileBuilder {
	/**
	 * 设置生成器基准路径
	 * 
	 ...
	 *             如果series为null则抛出此异常
	 */
	void addChartSeries(List<CategoryValuePoint> series, String seriesId)
			throws NullPointerException;
	 ...
	 *             如果series为null则抛出此异常
	 */
	void addChartSeries(List<CategoryValuePoint> series, boolean isCategory)
			throws NullPointerException;
