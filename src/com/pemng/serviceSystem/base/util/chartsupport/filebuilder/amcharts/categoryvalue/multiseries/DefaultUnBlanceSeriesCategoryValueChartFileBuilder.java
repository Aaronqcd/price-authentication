...
import com.pemng.serviceSystem.base.util.chartsupport.chart.data.series.unblancecategoryvalue.DefaultUnblanceCategoryValueSeries;
...
public class DefaultUnBlanceSeriesCategoryValueChartFileBuilder implements
UnBlanceSeriesCategoryValueChartFileBuilder {
	// 生成器的基准目录
	...
	// 数据加载时使用的图表
	private AmchartsUnblanceSeriesCategoryValueChart chart;
	 ...
	 *            操作的C/V图表
	 */
	public void setChart(AmchartsUnblanceSeriesCategoryValueChart chart) {
		this.chart = chart;
	}

	
	public void addChartSeries(List<UnblanceCategoryValuePoint> series)
			throws NullPointerException {
		addChartSeries(series, false);
	}

	
	public void addChartSeries(List<UnblanceCategoryValuePoint> series, String seriesId)
			throws NullPointerException {
	...
	public void addChartSeries(List<UnblanceCategoryValuePoint> series,
		...
		UnblanceCategoryValueSeries s = getSeries(series);
	...
	public void addChartSeries(List<UnblanceCategoryValuePoint> series,
		...
		UnblanceCategoryValueSeries s = getSeries(series, seriesId);
		chart.addCategoryValueSeries(s, isCategory);
	}
	...
	private UnblanceCategoryValueSeries getSeries(List<UnblanceCategoryValuePoint> series) {
		int number = chart.listCategoryValueSeries().size();
		UnblanceCategoryValueSeries s = new DefaultUnblanceCategoryValueSeries();
		s.setId("" + number);
		for (UnblanceCategoryValuePoint point : series) {
