<!-- 
	复核裁定管理
	/PEMng/WebRoot/jsp/cms/review_rule_list.jsp
 -->
...
<html>
	...
	<script type="text/javascript">
		...
		function searchCms(){
			document.searchForm.action="${pageContext.request.contextPath}/cms/reviewRuleList.action";
	...
	<h3>复核裁定管理</h3>
		...
		<div class="box3-tc" id="searchCloseDiv">
				<form action="${pageContext.request.contextPath}/cms/reviewRuleList.action" method="post" name="searchForm" id="searchForm">
					<s:hidden name="cmsDto.cmsType" id="cmsDto.cmsType" value="3"/>
					<s:hidden name="cmsDto.flag" id="cmsDto.flag" value="2"/>
						<table>
							<tr>
								<th>委托内容：</th>
								<td>
							...
							<tr>
								<th>委托日期:</th>
								<td colspan="7">
									<s:textfield name="cmsDto.beginTime1" id="beginTime1" readonly="true" cssClass="input1" size="12" /> 
							...
							<tr>
								<td colspan="8" align="right">
									...
									<input buttonAction="list" name="button" type="button"  class="anniu" value="新增" onclick="javascript:toCmsAdd(this);" />
					...
					<s:hidden name="cmsFlag" value="2"/>
						<table id="cms_info" border="0" cellpadding="0" cellspacing="0">
							<tr>
								...
								<th width="24%" align="center">委托内容</th>
								<th width="13%" align="center">委托单位简称</th>
							...
							<s:iterator value="cmList" status="status">
								<tr <s:if test="prtDt != null">class="tablerowhighlight"</s:if><s:elseif test="%{#status.index%2==0}">class="td1"</s:elseif>>
									<td id="checkId_<s:property value='id'/>" align="left">
							...
							<s:if test="cmList != null && cmList.size()>0">
								<tr class="tablecount">
									<td width="15%" colspan="10" style="text-align: left">&nbsp;&nbsp;&nbsp;统计&nbsp;&nbsp;&nbsp;数量:${dataMap.numCnt}&nbsp;&nbsp;&nbsp;金额:${dataMap.mnyCnt}</td>
								</tr> 
							</s:if> 
						</table>
						</form>
