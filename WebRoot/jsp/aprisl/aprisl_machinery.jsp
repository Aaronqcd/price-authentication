	...
	jQuery(document).ready(
			...
			<!-- 机器设备  -->
				<table>
					...
					<tr>
						<th>产地：</th>
						<td><s:textfield id="mfArea" name="aprislDto.mfArea" cssClass="input1" /></td>
						<th style="width: 150px;">市场价格(￥)：</th>
						<td><s:textfield id="orgnlPrc" name="aprislDto.orgnlPrc" cssClass="input1" />元</td>
					</tr>
					<tr>
						<th>购置地点：</th>
						<td><s:textfield id="mfBuyAdd" name="aprislDto.mfBuyAdd" cssClass="input1" /></td>
						<th></th>
						<td></td>
					</tr>
					<tr>
						...
						<th style="width: 150px;">是否正在使用：</th>
						<td>
					...
					<tr>
						<th colspan="1" style="width: 150px;">鉴定价格(￥)：</th>
