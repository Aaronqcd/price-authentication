			...
			<!-- 机动车-->
				...
				<table>
					...
					<tr>
						...
						<td>
						<input type="text" name="aprislDto.vcInitRegDt" id="vcInitRegDt" value="<s:date name="aprislDto.vcInitRegDt" format="yyyy-MM-dd"/>"
										readonly="readonly" class="input1"/> 
									<img onclick="WdatePicker({el:'vcInitRegDt',readOnly:true});" src="${pageContext.request.contextPath}/images/ril.png"
