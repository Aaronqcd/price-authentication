...
function pageQuery(page){
	...
	document.searchForm.action=action+"?pager.currentPage="+page+"&pager.pageSize="+document.getElementById('pgSize').value;
	/*if($("#currentPage")){
		$("#searchForm").append('<input type="checkbox" id="currentPage" value="'+page+'" name="pager.currentPage"/>');
	}else{
		$("#currentPage").val();
	}*/
