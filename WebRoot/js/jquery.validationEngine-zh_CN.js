    ...
    $.validationEngineLanguage = {
        newLang: function(){
            $.validationEngineLanguage.allRules = {
                ...
                "emails": {
                    // Shamelessly lifted from Scott Gonzalez via the Bassistance Validation plugin http://projects.scottsplayground.com/email_address_validation/
                    "regex":  /^([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+@([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+\.[a-zA-Z]{2,3}(,([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+@([a-zA-Z0-9]+[_|\_|\.]?)*[a-zA-Z0-9]+\.[a-zA-Z]{2,3})*$/,
                    "alertText": "* 邮件地址无效"
                },
                "integer": {
                    "regex": /^[\-\+]?\d+$/,
				...
				"bill_amnt": {
                    "regex": /^\d+(\.\d{1,2})?$/,
                    "alertText": "* 请输入正确格式的金额,最多支持2位小数"
                },
                "quty_rate": {
                	"regex": /^\d+(\.\d{1,4})?$/,
                	"alertText": "* 请输入正确格式的数量,最多支持4位小数"
                },
                "number": {
                ...
                "ajaxSourceNo": {
                    // remote json service location
                    "url": contextPath+"/costdiffrence/testSourceTypeAction.action",
                    // error
                    "alertText": "* 来源单号不存在！",
                    "alertText2": "* 来源单号已经存在！",
                    "alertTextOk": "* 验证通过！",
