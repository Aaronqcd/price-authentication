...
(/** @lends <global> */function($, window, document, undefined) {
	...
	var DataTable = function( oInit )
	{
		...
		function _fnUpdateInfo ( oSettings )
		{
			...
			var
				...
				sStartPage = Math.ceil(sStart/oSettings._iDisplayLength),
				sTotlePage = Math.ceil(sTotal/oSettings._iDisplayLength),
				sOut;
			...
			else if ( oSettings.fnRecordsDisplay() == oSettings.fnRecordsTotal() )
			{
				...
				sOut = oSettings.oLanguage.sInfo.
						...
						replace('_STATR_PAGE_', sStartPage).
						replace('_TOTLE_PAGE_', sTotlePage)+ 
					oSettings.oLanguage.sInfoPostFix;
			}
			else
			{
	...
	DataTable.defaults = {
		...
		"oLanguage": {
			...
			"sInfo": "共_TOTAL_条记录 _START_/_END_ 条 _STATR_PAGE_/_TOTLE_PAGE_页",
