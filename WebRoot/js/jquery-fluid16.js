...
Toggle : function(){
	...
	$.each(
		["grid", "paragraphs", "blockquote", "list-items", "section-menu", "tables", "forms", "login-forms", "search", "articles", "accordion", "claim"],
		function() {
...
Accordion: function(){
	$("#accordion").accordion({
        ...
        data.newHeader.css({
            "font-weight": "bold",
            "background": "#fff url(img/arrow_go.gif) 2px 4px no-repeat"
        });

        data.oldHeader.css({
            "font-weight": "normal",
            "background": "#eee url(img/arrow_go.gif) 2px 4px no-repeat"
        });
